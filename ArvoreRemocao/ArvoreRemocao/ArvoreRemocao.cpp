...
void removerElementoArvore(NO* no, int valor) {
    ...
    if (atual->esq == NULL && atual->dir == NULL) {
        if (pai == NULL) {
            // O elemento a ser removido é a raiz da árvore.
            raiz = NULL;
        } else {
            // Remove o elemento (atual) do pai
            if (pai->esq == atual) {
                pai->esq = NULL;
            } else {
                pai->dir = NULL;
    ...
    // caso 2: um filho
        ...
        if (pai == NULL) {
            ...
            // Atualiza o pai para apontar para o filho
            if (pai->esq == atual) {
                pai->esq = filho;
            } else {
                pai->dir = filho;
    ...
    // caso 3: dois filhos
        ...
        // Encontra o nó mais à esquerda da sub-árvore direita (sucessor)
        ...
        // Se o sucessor tem um filho à direita, o liga ao pai do sucessor
